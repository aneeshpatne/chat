  ...
  return (
    <>
      {!open && (
        <button
          onClick={toggle}
          className="fixed top-4 left-4 z-50 p-2 bg-sidebar text-sidebar-foreground rounded-full hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all"
        >
          <ArrowRight />
        </button>
      )}
